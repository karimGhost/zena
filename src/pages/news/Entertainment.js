...
export default function Entertainment() {
  ...
  const fetchUrl = requests.fetchEntertainment;
...
<PagesData off={off} setoff={setoff}  da={da} />
    ...
    <h2 className="H23">Entertainent</h2>
          ...
          {currentNews.map(news => (
            <div className="more_news_tab">
              ...
              <p className="descript">
                ...
                <br />
                {news.description}
                <Link to="/news/Entertainment"> <button className='readmore' onClick={() => locale(news.url)}>...Read More</button></Link>
              </p>
